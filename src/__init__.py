...
def create_app():
    ...
    from src.backend.apis import shopping_trip, shopping_list, shopping_list_integration, budget, pantry, meals, meal_plan_compat, meal_goals, ingredient_matching
